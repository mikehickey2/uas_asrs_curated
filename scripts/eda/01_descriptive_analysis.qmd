...
tbl <- readr::read_csv(here::here("output/tables/table1_overview_completeness.csv"), show_col_types = FALSE)
knitr::kable(tbl)
```
...
tbl <- readr::read_csv(here::here("output/tables/table2_operational_context.csv"), show_col_types = FALSE)
knitr::kable(tbl)
```
...
tbl <- readr::read_csv(here::here("output/tables/table2_optional_crosstabs.csv"), show_col_types = FALSE)
knitr::kable(tbl)
```
...
tbl <- readr::read_csv(here::here("output/tables/table3_severity_markers.csv"), show_col_types = FALSE)
knitr::kable(tbl)
```
...
tbl <- readr::read_csv(here::here("output/tables/table4_nmac_by_context.csv"), show_col_types = FALSE)
knitr::kable(tbl)
```
...
**Assembly timestamp**: 2025-12-27 00:24:06
